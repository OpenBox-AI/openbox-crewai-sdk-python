"""E2E test for a complex hierarchical crew exercising the multi-agent timeline.
...
Usage:
    python3 -m tests.e2e.hierarchical_complex.test_complex_hierarchical
"""
...
COMPLIANCE_PREFIX = "OPENBOX_COMPLIANCE_REVIEWER"
...
def test_complex_hierarchical_pipeline() -> None:
    """Six-agent hierarchical crew produces an investor brief end-to-end."""
    _ensure_temp_dir()
...
def main() -> None:
    tests = [
        ("complex_hierarchical_pipeline", test_complex_hierarchical_pipeline),
    ]
    ...
    print(f"\n{'=' * 60}")
    print("  COMPLEX HIERARCHICAL GOVERNANCE TEST SUMMARY")
    print(f"{'=' * 60}")
